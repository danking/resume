...
\job{Harvard University}
    ...
    {}{
  \item Studying Programming Languages, advised by Stephen Chong
}
...
\job{Analysis of Static Analysis Strategies for JavaScript}
    {}
    {November 2014--Present}
    {Advised by Stephen Chong}
    {}{
  \item{Implementing the LambdaJS semantics in a MAAM framework for monadic
      abstract interpretation}
  \item{Using the MAAM framework to analyze the performance-accuracy curves
      of various static analysis strategies}
}
...
\job{Secure Use of Privileges in IFC and MAC Systems}
    ...
    {Advised by Stephen Chong}
    {}{
  \item{Designed a system to enable local reasoning about privilege protections
      to infer system wide properties}
  \item{Under review at IEEE Security \& Privacy 2015}
}
