...
\begin{tabbing}
\textbf{Languages:}\hspace{.2in}\= Fluent in Scheme, ECMAScript, Ruby,
                   Java, and RegEx; Accomplished in SCSH, Emacs Lisp, and \LaTeX\\
\textbf{Systems:}\> GNU/Linux, OS X, Windows (9x, XP, Vista)\\
\textbf{Software:}\> GNU Emacs, Git, Vim, Subversion, Eclipse IDE (and RCP)
\end{tabbing}\vspace{-15pt}
