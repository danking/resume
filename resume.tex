...
\job{The Broad Institute of MIT and Harvard}
    ...
    \item{Leading the development of a Kubernetes-based Hail as a Service}
    ...
    \item{Implemented a Continuous Integration \& Delivery system, from scratch}

    \item{Implemented statistical genetics methods in a scalable manner using
      Hail}

    \item{Established the Hail co-op/internship program, mentored
      co-ops/interns, leading to a hire}
...
\begin{itemize}
\item \textbf{Languages:} Python, C++, Scala, Java, Haskell, Racket
\item \textbf{Tools:} Emacs, Git, Kubernetes, Make, Google Cloud Platform, Spark
\end{itemize}
\vspace{-15pt}
